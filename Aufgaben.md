...
3)  Alle 10 Minuten fragt die "main.qml" die Messwerte bei der "WeatherStation" ab und aktualisiert die Anzeige.
4) "main.qml" Die Uhrzeit ohne Sekunden anzeigen.
5) "main.qml" Zusätzlich soll der Ort angegeben werden.